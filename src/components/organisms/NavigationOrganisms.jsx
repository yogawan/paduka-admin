...
const NavigationOrganisms = () => {
  return (
    <nav className="fixed">
      <ul className="flex flex-col h-screen items-start pt-[96px] w-[256px] pl-[12px] bg-[#EEEEEE] bg-blur">

        <li className="flex p-5 m-1 rounded-full text-black font-thin hover:bg-[#DDDDDD]">
          <svg
        ...
        <li className="flex p-5 m-1 rounded-full text-black font-thin hover:bg-[#DDDDDD]">
          ...
          <Link className="pl-2" to={"/form"}>Tambah Data</Link>
        </li>
