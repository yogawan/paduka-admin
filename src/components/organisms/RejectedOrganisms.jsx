  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const approved = response.data.filter((item) => item.Status === "Ditolak");
    ...
    <div>
      ...
      {approvedData.length === 0 ? (
        ...
        <div className="flex flex-col">
          <h1 className="text-[16px] font-thin mb-4">Ditolak</h1>
...
export default RejectedOrganisms;
